        ...
        <div className="px-10 w-full flex flex-col h-[98dvh] max-h-[1400px] pb-10 gap-4">
          <div className="flex h-full gap-8">
            ...
            <ScrollArea className="w-full">
              ...
              <div className="flex flex-col gap-8 mt-2 md:mt-0 pb-10 max-w-3xl w-full">
                <section id="overview" className="scroll-mt-24">
                  <h1 className="text-2xl font-medium leading-tight">
                    JSC Language Docs
                  </h1>
                  <p className="text-muted-foreground leading-relaxed mt-2">
                    JSC (Just Simple Compiler) is a small language with a
                    minimal syntax designed for learning. Every statement ends
                    with a semicolon, strings use double quotes, and blocks use
                    a lightweight <span className="font-mono">::</span> and{" "}
                ...
                <section id="variables" className="scroll-mt-24">
                  ...
                  <p className="text-muted-foreground leading-relaxed mt-2">
                    ...
                    <span className="font-mono">var</span> and assign with{" "}
                    <span className="font-mono">=</span>. Values can be numbers
                    or strings.
                  </p>
                ...
                <section id="render" className="scroll-mt-24">
                  ...
                  <p className="text-muted-foreground leading-relaxed mt-2">
                    Use <span className="font-mono">render</span> to print to
                    the console or stdout.
                  </p>
                  <div className="bg-muted p-4 rounded-md mt-3 font-mono text-sm">
                ...
                <section id="comments" className="scroll-mt-24">
                  ...
                  <p className="text-muted-foreground leading-relaxed mt-2">
                    Comments start with <span className="font-mono">*c</span>{" "}
                ...
                <section id="about" className="scroll-mt-24">
                  ...
                  <p className="text-muted-foreground leading-relaxed mt-2">
                    JSC is a custom programming language with its own
                    interpreter, built in Python for the web playground. It is
                    intentionally small so you can focus on parsing, execution,
                    and language design fundamentals.
                  </p>
                </section>
              </div>
            </ScrollArea>
